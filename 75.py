...
class Test_registration(unittest.TestCase):
    def test_geristraton_url1(self):
        ...
        input1.send_keys("Ivan.Petrov@mail.com")
        ...
        self.assertEqual("Congratulations! You have successfully registered!", welcome_text, 'Registration fail!!!')
